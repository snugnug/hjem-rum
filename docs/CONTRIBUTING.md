...
> \[!IMPORTANT\] When writing options for any Nix module, do NOT make any option
> depend on a value from `config`. Options should be pure, or it will interfere
> with modules evaluation.
