...
At the top of any module, there should always be a let ... in syntax. Within this, functions should have their location aliased, cfg should be aliased, and any generators should have an alias as well. Here's an example for a module that makes use of the TOML generator used in nixpkgs:
...
> [!NOTE]
> We should consider adding the case used in the hyprland module, as it represents a more unique case.
